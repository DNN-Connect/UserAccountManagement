...
Imports Connect.Modules.Accounts.UserForms.UI
...
#Region "Private Methods"
    ...
    Private Sub ProcessAdminNotification(ByVal Body As String, CurrentUser As UserInfo)
        ...
        Dim NotificationUsers As ArrayList = RoleController.Instance.GetUsersByRole(PortalId, NotifyRole)
...
#Region "Optional Interfaces"
    ...
    Public ReadOnly Property ModuleActions() As Actions.ModuleActionCollection Implements IActionable.ModuleActions
        Get
            ...
            Actions.Add(GetNextActionID, Localization.GetString("ManageTemplates.Action", LocalResourceFile), ModuleActionType.AddContent, "", "", EditUrl("ManageTemplates"), False, DotNetNuke.Security.SecurityAccessLevel.Edit, True, False)
            Return Actions
        End Get
    End Property
