<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ListUsers.ascx.vb" Inherits="Connect.Modules.Accounts.AccountManagement.ListUsers" %>
...
<div class="connect_main">
        ...
        <ul class="dnnActions dnnClear" runat="server" id="GridActions">
        ...
        close: function () {
            ...
            function bindGridActions()
            {
                ...
                $('.cmdAccountSetRoles').click(function (event) {    
                    ...
                    var el = $(this);
                    showUserRoles(el.data("uid"), el);
                });  
        
            }

            $(".cmdUpdateUserRoles").click(function(){
                ...
                var roles = [];
                $('.connectRolesDialog input:checked').each(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: sf.getServiceRoot('Connect/UserAccounts') + 'UserAccounts/SetUserRoles',
                    beforeSend: sf.setModuleHeaders,
                    data: { UserId: uid, PortalId: portalId, Roles: roles },
            ...
            {
                $('.connect-roles-content input').prop('checked', false);
                var container = $(".connectRolesDialog");
                ...
                $(".cmdUpdateUserRoles").data("uid", userid);
                ...
                $.ajax({
                    ...
                    success: function(data){ 
                        $.map(data, function (item) {
                            var checkbox = $('.connect-roles-content input[value="' + item.RoleId + '"]');
                            if (checkbox){
            ...
            function getStatusLinks(user){    
                ...
                var setAccountAuthorizedLink        = '<li><a href="#" data-uid="' + uid + '" class="cmdAccountSetAuthorized"><i class="fa fa-lock"></i></a></li>';
                var setAccountUnAuthorizedLink      = '<li><a href="#" data-uid="' + uid + '" class="cmdAccountSetUnAuthorized"><i class="fa fa-check-square-o"></i></a></li>';
                var setRoleMembershipApprovedLink   = '<li><a href="#" data-uid="' + uid + '" data-roleid="' + roleId + '" class="cmdRoleMembershipSetApproved"><i class="fa fa-lock"></i></a></li>';
                var setRoleMembershipPendingLink    = '<li><a href="#" data-uid="' + uid + '" data-roleid="' + roleId + '" class="cmdRoleMembershipSetPending"><i class="fa fa-check-square-o"></i></a></li>';
            ...
            function getActionLinks(user){        
                ...
                var editLink                        = '<li><a href="' + editUrl + '/UserId/' + uid + '/RoleId/' + roleId + '"><i class="fa fa-edit"></i></a></li>';
        
                var setAccountDeletedLink           = '<li><a href="#" data-uid="' + uid + '" class="cmdAccountSetDeleted"><i class="fa fa-remove"></i></a></li>';
                var setAccountRemovedLink           = '<li><a href="#" data-uid="' + uid + '" class="cmdAccountSetRemoved"><i class="fa fa-remove"></i></a></li>';
                var setAccountRestoredLink          = '<li><a href="#" data-uid="' + uid + '" class="cmdAccountSetRestored"><i class="fa fa-undo"></i></a></li>';
                var setRoleMembershipRemovedLink    = '<li><a href="#" data-uid="' + uid + '" data-roleid="' + roleId + '" class="cmdRoleMembershipSetRemoved"><i class="fa fa-remove"></i></a></li>';
                var setUserRolesLink                = '<li><a href="#" data-uid="' + uid + '" class="cmdAccountSetRoles"><i class="fa fa-group"></i></a></li>';
